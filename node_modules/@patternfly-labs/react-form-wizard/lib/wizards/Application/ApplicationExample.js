...
export function ApplicationExample() {
    ...
    return (_jsx(ApplicationWizard, { addClusterSets: "https://github.com/patternfly-labs/react-form-wizard", ansibleCredentials: ansibleCredentials, argoServers: servers, namespaces: namespaces, onSubmit: onSubmit, onCancel: () => onCancel(history), placements: placements, channels: channels, timeZones: timeZones }, void 0));
}
//# sourceMappingURL=ApplicationExample.js.map
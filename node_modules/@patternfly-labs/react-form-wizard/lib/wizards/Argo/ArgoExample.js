...
export function ArgoExample() {
    ...
    return (_jsx(ArgoWizard, { addClusterSets: "https://github.com/patternfly-labs/react-form-wizard", ansibleCredentials: ansibleCredentials, argoServers: servers, namespaces: namespaces, onSubmit: onSubmit, onCancel: () => onCancel(history), placements: placements, channels: channels, timeZones: timeZones, getGitRevisions: () => {
            return new Promise((resolve) => resolve(['branch-1', 'branch-2']));
        }, getGitPaths: () => {
            return new Promise((resolve) => resolve(['path-1', 'path-2']));
        } }, void 0));
}
//# sourceMappingURL=ArgoExample.js.map
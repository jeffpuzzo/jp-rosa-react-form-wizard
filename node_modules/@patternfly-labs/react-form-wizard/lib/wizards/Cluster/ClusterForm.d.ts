...
export declare function ClusterForm(): JSX.Element;
export declare function ControlPlaneStep(): JSX.Element;
export declare function WorkerPoolsStep(): JSX.Element;

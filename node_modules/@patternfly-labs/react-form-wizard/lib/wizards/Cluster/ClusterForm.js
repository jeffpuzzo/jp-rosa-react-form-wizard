...
import { ArrayInput, Checkbox, KeyValue, Multiselect, Section, Select, Step, TextDetail, TextInput, Tile, Tiles, WizardPage, } from '../../src';
import YamlTemplate from './Cluster.hbs';
export function ClusterForm() {
    const history = useHistory();
    return (_jsxs(WizardPage, { title: "Create cluster", template: YamlTemplate, breadcrumb: [{ label: 'Managed clusters', to: '.' }], onSubmit: () => Promise.resolve(undefined), onCancel: () => history.push('./?route=wizards'), children: [_jsxs(Step, { label: "Infrastructure provider", id: "infrastructure-provider", children: [_jsxs(Section, { label: "Infrastructure provider", prompt: "Select the infrastructure for the cluster", children: [_jsxs(Tiles, { path: "provider", label: "Cloud infrastructure providers", children: [_jsx(Tile, { id: "aws", value: "aws", label: "Amazon Web Services" }, void 0), _jsx(Tile, { id: "azr", value: "azr", label: "Microsoft Azure" }, void 0), _jsx(Tile, { id: "gcp", value: "gcp", label: "Google Cloud Platform" }, void 0), _jsx(Tile, { id: "ost", value: "ost", label: "Red Hat OpenStack Platform" }, void 0), _jsx(Tile, { id: "vsp", value: "vsp", label: "VMWare vSphere" }, void 0), _jsx(Tile, { id: "bare", value: "bare", label: "Bare metal" }, void 0)] }, void 0), _jsx(Tiles, { id: "centrallyManagedCredentials", path: "provider", label: "Centrally managed", children: _jsx(Tile, { id: "onp", value: "onp", label: "On premise" }, void 0) }, void 0)] }, void 0), _jsx(Section, { label: "Credentials", prompt: "Select the infrastructure for the cluster", hidden: (item) => !item.provider, children: _jsx(Select, { path: "credential", label: "Infrastructure credentials", placeholder: "Select the credentials for the infrastructure", options: ['default'], required: true }, void 0) }, void 0)] }, void 0), _jsx(Step, { label: "Cluster details", id: "cluster-details", children: _jsxs(Section, { label: "Cluster details", prompt: "Enter the cluster details", children: [_jsx(TextInput, { path: "name", label: "Cluster name", placeholder: "Enter the cluster name", required: true }, void 0), _jsx(Select, { path: "region", label: "Region", options: Object.keys(awsRegions) }, void 0), _jsx(Select, { path: "clusterSet", label: "Cluster set", placeholder: "Select a cluster set", helperText: "A cluster sets is a group of clusters that can be targeted as a group.", options: ['default'], required: true }, void 0), _jsx(TextInput, { path: "baseDnsDomain", label: "Base DNS domain", placeholder: "Enter the Base DNS domain" }, void 0), _jsx(Select, { path: "releaseImage", label: "Release image", placeholder: "Select a release image", options: ['default'], required: true }, void 0), _jsx(KeyValue, { path: "labels", label: "Additional labels" }, void 0)] }, void 0) }, void 0), _jsx(Step, { label: "Control plane", id: "control-plane", children: _jsx(ControlPlaneStep, {}, void 0) }, void 0), _jsx(Step, { label: "Worker pools", id: "worker-pools", children: _jsx(WorkerPoolsStep, {}, void 0) }, void 0), _jsx(Step, { label: "Networking", id: "networking", children: _jsxs(Section, { label: "Networking", prompt: "Enter networking options", description: "Configure network access for your cluster. One network is created by default.", children: [_jsx(Select, { path: "networkType", label: "Network type", options: ['default'], required: true }, void 0), _jsxs(ArrayInput, { path: "networks", label: "Networks", placeholder: "Add network", collapsedContent: _jsx(TextDetail, { path: "clusterCidr", placeholder: "Expand to edit the network" }, void 0), children: [_jsx(TextInput, { path: "clusterCidr", label: "Cluster network CIDR" }, void 0), _jsx(TextInput, { path: "hostPrefix", label: "Network host prefix" }, void 0), _jsx(TextInput, { path: "serviceCidr", label: "Service network Cidr" }, void 0), _jsx(TextInput, { path: "machienCidr", label: "Machine CIDR" }, void 0)] }, void 0)] }, void 0) }, void 0), _jsx(Step, { label: "Proxy", id: "proxy", children: _jsxs(Section, { label: "Proxy", prompt: "Configure a proxy", description: "Production environments can deny direct access to the Internet and instead have an HTTP or HTTPS proxy available. You can configure a new OpenShift Container Platform cluster to use a proxy by configuring the proxy settings.", children: [_jsx(Checkbox, { path: "useProxy", label: "Use proxy" }, void 0), _jsx(TextInput, { path: "httpProxy", label: "Http Proxy ", helperText: "Requires this format: http://<username>:<pswd>@<ip>:<port>", required: true, hidden: (item) => !item.useProxy }, void 0), _jsx(TextInput, { path: "httpsProxy", label: "Https Proxy", helperText: "Requires this format: https://<username>:<pswd>@<ip>:<port>", required: true, hidden: (item) => !item.useProxy }, void 0), _jsx(TextInput, { path: "noProxy", label: "No Proxy", helperText: "By default, all cluster egress traffic is proxied, including calls to hosting cloud provider APIs. Add sites to No Proxy to bypass the proxy if necessary.", hidden: (item) => !item.useProxy }, void 0), _jsx(TextInput, { path: "additionalTrustBundle", label: "Additional Trust Bundle", hidden: (item) => !item.useProxy }, void 0)] }, void 0) }, void 0), _jsx(Step, { label: "Automation", id: "automation", children: _jsx(Section, { label: "Automation", prompt: "Configure a Ansible automation", description: "Choose an automation job template to automatically run Ansible jobs at different stages of a cluster's life cycle. To use this feature, the Ansible Automation Platform Resource Operator must be installed.", children: _jsx(Select, { path: "ansibleTemplate", label: "Ansible Automation Template", options: ['default'] }, void 0) }, void 0) }, void 0)] }, void 0));
}
export function ControlPlaneStep() {
    return (_jsxs(Section, { label: "Control plane", prompt: "Enter the control plane details", description: "Three control plane nodes will be created to control this cluster unless single node is enabled, in which case there will only be one control plane node.", children: [_jsx(Multiselect, { path: "zones", label: "Zones", children: awsRegions['us-east-1'].map((value) => (_jsx(SelectOption, { value: value }, value))) }, void 0), _jsx(Select, { path: "instanceType", label: "Instance type", placeholder: "Select the instance type", options: AWSmasterInstanceTypes.map((instanceType) => ({ value: instanceType.value, label: instanceType.description })), required: true }, void 0), _jsx(Select, { path: "rootStorage", label: "Root storage (GiB)", options: ['default'] }, void 0)] }, void 0));
}
export function WorkerPoolsStep() {
    return (_jsx(Section, { label: "Worker pools", prompt: "Enter the worker pools", description: "One or more worker nodes will be created to run the container workloads in this cluster.", children: _jsxs(ArrayInput, { path: "workerPools", label: "Worker pools", placeholder: "Add worker pool", collapsedContent: _jsx(TextDetail, { path: "name", placeholder: "Expand to edit the worker pool details" }, void 0), children: [_jsx(TextInput, { path: "name", label: "Pool name" }, void 0), _jsx(Select, { path: "zones", label: "Zones", options: ['default'] }, void 0), _jsx(Select, { path: "instanceType", label: "Instance type", options: ['default'] }, void 0), _jsx(Select, { path: "rootStorage", label: "Root storage (GiB)", options: ['default'] }, void 0)] }, void 0) }, void 0));
}
...
//# sourceMappingURL=ClusterForm.js.map
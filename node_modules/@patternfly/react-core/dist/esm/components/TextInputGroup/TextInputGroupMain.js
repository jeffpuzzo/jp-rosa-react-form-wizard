...
export const TextInputGroupMain = (_a) => {
    var { children, className, icon, type = 'text', onChange = () => undefined, onFocus, onBlur, 'aria-label': ariaLabel = 'Type to filter', value: inputValue, placeholder: inputPlaceHolder } = _a, props = __rest(_a, ["children", "className", "icon", "type", "onChange", "onFocus", "onBlur", 'aria-label', "value", "placeholder"]);
    ...
    return (React.createElement("div", Object.assign({ className: css(styles.textInputGroupMain, icon && styles.modifiers.icon, className) }, props),
        ...
        React.createElement("span", { className: css(styles.textInputGroupText) },
            ...
            React.createElement("input", { type: type, className: css(styles.textInputGroupTextInput), "aria-label": ariaLabel, disabled: isDisabled, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, value: inputValue || '', placeholder: inputPlaceHolder }))));
};

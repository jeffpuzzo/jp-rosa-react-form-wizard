...
const Label = (_a) => {
    ...
    if (isEditable) {
        content = (React.createElement("button", Object.assign({ ref: editableButtonRef, className: react_styles_1.css(label_1.default.labelEditableText), onClick: e => {
                setIsEditableActive(true);
                e.stopPropagation();
    ...
    return (React.createElement(LabelComponent, Object.assign({}, props, { className: react_styles_1.css(label_1.default.label, colorStyles[color], variant === 'outline' && label_1.default.modifiers.outline, isOverflowLabel && label_1.default.modifiers.overflow, isCompact && label_1.default.modifiers.compact, isEditable && label_group_1.default.modifiers.editable, isEditableActive && label_1.default.modifiers.editableActive, className) }),
        ...
        isEditableActive && (React.createElement("input", Object.assign({ className: react_styles_1.css(label_1.default.labelEditableText), type: "text", id: "editable-input", ref: editableInputRef, value: currValue, onChange: updateVal }, editableProps)))));
};
exports.Label = Label;

...
class SelectToggle extends React.Component {
    constructor(props) {
        ...
        this.handleGlobalKeys = (event) => {
            ...
            if (isOpen && event.key === selectConstants_1.KeyTypes.Tab && hasFooter) {

...
const TextInputGroupMain = (_a) => {
    var { children, className, icon, type = 'text', onChange = () => undefined, onFocus, onBlur, 'aria-label': ariaLabel = 'Type to filter', value: inputValue, placeholder: inputPlaceHolder } = _a, props = tslib_1.__rest(_a, ["children", "className", "icon", "type", "onChange", "onFocus", "onBlur", 'aria-label', "value", "placeholder"]);
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(text_input_group_1.default.textInputGroupMain, icon && text_input_group_1.default.modifiers.icon, className) }, props),
        ...
        React.createElement("span", { className: react_styles_1.css(text_input_group_1.default.textInputGroupText) },
            ...
            React.createElement("input", { type: type, className: react_styles_1.css(text_input_group_1.default.textInputGroupTextInput), "aria-label": ariaLabel, disabled: isDisabled, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, value: inputValue || '', placeholder: inputPlaceHolder }))));
};

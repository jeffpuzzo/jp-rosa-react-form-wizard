...
class TimePicker extends React.Component {
    constructor(props) {
        ...
        this.onDocClick = (event) => {
            var _a, _b, _c, _d;
            const clickedOnToggle = (_b = (_a = this.parentRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.contains(event.target);
        ...
        this.handleGlobalKeys = (event) => {
            ...
            if ((_b = (_a = this.inputRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.contains(event.target)) {
                if (!isOpen && event.key !== Select_1.KeyTypes.Tab) {
                    ...
                    if (event.key === Select_1.KeyTypes.Escape || event.key === Select_1.KeyTypes.Tab) {
                        this.onToggle(false);
                    }
                    ...
                    else if (event.key === Select_1.KeyTypes.ArrowDown || event.key === Select_1.KeyTypes.ArrowUp) {
                ...
                if (event.key === Select_1.KeyTypes.ArrowDown) {
                ...
                else if (event.key === Select_1.KeyTypes.Escape || event.key === Select_1.KeyTypes.Tab) {
    ...
    render() {
        ...
        onChange, time, validateTime, minTime, maxTime, includeSeconds } = _a, 
        /* eslint-enable @typescript-eslint/no-unused-vars */
        props = tslib_1.__rest(_a, ['aria-label', "isDisabled", "className", "placeholder", "id", "menuAppendTo", "is24Hour", "invalidFormatErrorMessage", "invalidMinMaxErrorMessage", "stepMinutes", "width", "delimiter", "inputProps", "onChange", "time", "validateTime", "minTime", "maxTime", "includeSeconds"]);
        ...
        const options = TimePickerUtils_1.makeTimeOptions(stepMinutes, !is24Hour, delimiter, minTimeState, maxTimeState);
        ...
        const menuContainer = (React.createElement(Menu_1.Menu, { ref: this.menuRef, isScrollable: true },
            React.createElement(Menu_1.MenuContent, { maxMenuHeight: "200px" },
                React.createElement(Menu_1.MenuList, { "aria-labelledby": `${randomId}-input` }, options.map((option, index) => (React.createElement(Menu_1.MenuItem, { onClick: this.onSelect, key: option, id: `${randomId}-option-${index}` }, option)))))));
        const textInput = (React.createElement(TextInput_1.TextInput, Object.assign({ className: react_styles_1.css(form_control_1.default.formControl), id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", iconVariant: "clock", onClick: this.onInputFocus, onFocus: this.onInputFocus, onChange: this.onInputChange, onBlur: this.onBlur, autoComplete: "off", isDisabled: isDisabled, ref: this.inputRef }, inputProps)));
        return (React.createElement("div", { className: react_styles_1.css(date_picker_1.default.datePicker, className) },
            React.createElement("div", Object.assign({ className: react_styles_1.css(date_picker_1.default.datePickerInput), style: style }, props),
                React.createElement(InputGroup_1.InputGroup, null,
                    React.createElement("div", { id: randomId, ref: this.parentRef },
                        React.createElement("div", { ref: this.toggleRef, style: { paddingLeft: '0' } }, menuAppendTo !== 'inline' ? (React.createElement(Popper_1.Popper, { appendTo: this.parentRef.current, trigger: textInput, popper: menuContainer, isVisible: isOpen })) : (textInput)),
